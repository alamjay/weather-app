                ...
                {todaysWeather ?
                    <>
                        <div className="flex">
                            ...
                            <p className="text-[28px] text-grey-800 leading-none text-gray-500">{todaysWeather?.humidity}%</p>
                        </div>
                        <div className="flex">
                            <p className="w-9/12">Pressure</p>
                            <div className="flex items-end">
                                <p className="text-[28px] text-grey-800 leading-none text-gray-500">{todaysWeather?.pressure}</p>
